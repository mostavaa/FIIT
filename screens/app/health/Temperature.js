    ...
    getData.then(resp => {
      if (resp.success) {
        ...
        setChartData({
          ...
          datasets: [
            {
              data: resp.payload[0].map(temp =>
                parseFloat(temp.value.substring(0, temp.value.length - 2)),
              ),
            },
          ],
        });
                ...
                <View style={{marginTop: 30}}>
                  ...
                  <View
                    ...
                    <Text
                      ...
                      {Math.max.apply(0, chartData.datasets[0].data)} F
                    </Text>
                  </View>
                  ...
                  <View
                    ...
                    <Text
                      ...
                      {Math.min.apply(0, chartData.datasets[0].data)} F
                    </Text>
                  </View>
                </View>
              </View>
