      ...
      if (resp.success) {
        ...
        setChartData({
          labels: resp.payload[0].map(
            weight => monthShortNames[new Date(weight.date).getMonth()],
          ),
          datasets: [
            {
              data: resp.payload[0].map(weight =>
                parseFloat(weight.value.slice(0, weight.value.length - 3)),
              ),
            },
          ],
        });
                ...
                <View style={{marginTop: 30}}>
                  ...
                  <View
                    ...
                    <Text
                      ...
                      {Math.max.apply(0, chartData.datasets[0].data)} lb
                    </Text>
                  </View>
                  ...
                  <View
                    ...
                    <Text
                      ...
                      {Math.min.apply(0, chartData.datasets[0].data)} lb
                    </Text>
                  </View>
                </View>
              </View>
