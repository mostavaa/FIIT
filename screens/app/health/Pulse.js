      ...
      if (resp.success) {
        ...
        setChartData({
          labels: resp.payload[0].map(
            pulse => monthShortNames[new Date(pulse.date).getMonth()],
          ),
          datasets: [
            {
              data: resp.payload[0].map(pulse => parseFloat(pulse.value)),
            },
          ],
        });
      }
                ...
                <View style={{marginTop: 30}}>
                  ...
                  <View
                    ...
                    <Text
                      ...
                      {Math.max.apply(0, chartData.datasets[0].data)} bpm
                    </Text>
                  </View>
                  ...
                  <View
                    ...
                    <Text
                      ...
                      {Math.min.apply(0, chartData.datasets[0].data)} bpm
                    </Text>
                  </View>
                </View>
              </View>
