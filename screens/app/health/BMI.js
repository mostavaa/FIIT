      ...
      if (resp.success) {
        ...
        setChartData({
          labels: resp.payload[0].map(
            bmi => monthShortNames[new Date(bmi.date).getMonth()],
          ),
          datasets: [
            {
              data: resp.payload[0].map(bmi =>
                parseFloat(bmi.value.slice(0, bmi.value.length - 6)),
              ),
            },
          ],
        });
                ...
                <View style={{marginTop: 30}}>
                  ...
                  <View
                        ...
                        {new Date(
                          response[
                            response.findIndex(el => {
                              return (
                                parseFloat(
                                  el.value.substring(0, el.value.length - 5),
                                ) ===
                    ...
                    <Text
                      ...
                      {Math.max.apply(0, chartData.datasets[0].data)} kg/m2
                    </Text>
                  </View>
                  ...
                  <View
                    ...
                    <Text
                      ...
                      {Math.min.apply(0, chartData.datasets[0].data)} kg/m2
                    </Text>
                  </View>
                </View>
              </View>
