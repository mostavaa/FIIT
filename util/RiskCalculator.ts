...
class RiskCalculation {
    ...
    if (params.BMI < 25) {
      ...
      if (params.gender === undefined) {
        ...
        if (params.race === 'Non-Hispanic White') percentage += 13;
          ...
          params.race === 'American Indian' ||
          params.race === 'American native'
        )
          percentage += 13;
        else if (params.race === 'Other' || params.race === undefined)
          percentage += 8;
  ...
  strokeRS = (params: strokeRS) => {
    ...
    else if (params.physicalActivity === 1 || params.physicalActivity === 2)
      score += 1;
  ...
  FRS = (params: FRS) => {
    ...
    if (params.gender === 'male') {
      ...
      else if (params.cholesterol >= 4.1 && params.cholesterol <= 5.19)
        score += 1;
      else if (params.cholesterol >= 5.2 && params.cholesterol <= 6.19)
        score += 2;
      else if (params.cholesterol >= 6.2 && params.cholesterol <= 7.2)
        score += 3;
      else if (params.cholesterol > 7.2) score += 4;

      // Systolic Blood Pressure Points
      if (params.bloodPressure < 120)
        score += params.bloodPressureTreated ? 0 : -2;
      else if (params.bloodPressure >= 120 && params.bloodPressure <= 129)
        score += params.bloodPressureTreated ? 2 : 0;
      else if (params.bloodPressure >= 130 && params.bloodPressure <= 139)
        score += params.bloodPressureTreated ? 3 : 1;
      else if (params.bloodPressure >= 140 && params.bloodPressure <= 149)
        score += params.bloodPressureTreated ? 4 : 2;
      else if (params.bloodPressure >= 150 && params.bloodPressure <= 159)
        score += params.bloodPressureTreated ? 4 : 2;
      else if (params.bloodPressure > 160)
        score += params.bloodPressureTreated ? 5 : 3;
      ...
      // Systolic Blood Pressure Points
      if (params.bloodPressure < 120)
        score += params.bloodPressureTreated ? -1 : -3;
      else if (params.bloodPressure >= 120 && params.bloodPressure <= 129)
        score += params.bloodPressureTreated ? 2 : 0;
      else if (params.bloodPressure >= 130 && params.bloodPressure <= 139)
        score += params.bloodPressureTreated ? 3 : 1;
      else if (params.bloodPressure >= 140 && params.bloodPressure <= 149)
        score += params.bloodPressureTreated ? 5 : 2;
      else if (params.bloodPressure >= 150 && params.bloodPressure <= 159)
        score += params.bloodPressureTreated ? 6 : 4;
      else if (params.bloodPressure > 160)
        score += params.bloodPressureTreated ? 7 : 5;
